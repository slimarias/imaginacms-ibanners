...
class SlideRepositoryTest extends BaseSliderTest
{
    ...
    public function can_create_slide()
    {
        ...
        $slider = $this->createSliderWithSlides('Homepage Ibanners', 'homepage', $numberOfSlides);
        $this->assertEquals($numberOfSlides, count($slider->slides));
    }

    /**
     * this is more of a Collection test, rather than Ibanners
     * @test
     */
    ...
    {
        $slideCount = rand(1,5);
        $slider = $this->createSliderWithSlides('Homepage Ibanners', 'homepage_slider', $slideCount);
